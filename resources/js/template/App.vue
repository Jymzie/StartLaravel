...
<template>
    <v-app>
        ...
        <v-app-bar clipped-left style="background-color: #4169E1;color:white" app v-show="!$router.history.current.path.includes('/error') && $route.name != 'login'" >
           ...
           <v-toolbar-title >FConverter</v-toolbar-title>
           <v-spacer/>
        ...
        <v-main>
           <router-view  style="background-image: url(images/background.png);background-size:cover" @setcookies="mSetCookies"></router-view>
        </v-main>
    </v-app>
  </template>
