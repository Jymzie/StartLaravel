...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      SkillDesc: [{
        title: 'Adaptability',
        desc: 'HyperText Markup Language is a standardized markup language that creates the fundamental structure of web pages by using tags to organize and format content that web browsers can interpret and display.'
      }, {
        title: 'Communication',
        desc: 'Cascading Style Sheets is a styling language that controls how web pages look and feel, allowing you to transform plain HTML content into beautifully formatted and responsive designs.'
      }, {
        title: 'Creativity',
        desc: 'A versatile programming language that brings websites to life by adding interactivity to web pages, allowing developers to create dynamic content, respond to user actions, and update information instantly without requiring page reloads.'
      }, {
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "v-list",
        _vm._l(_vm.SkillDesc, function (item, i) {
          return _c(
            "v-list-item",
            { key: i },
            [
              _c(
                "v-tooltip",
                {
                  attrs: { bottom: "", "min-width": "200", "max-width": "250" },
                  scopedSlots: _vm._u(
                    [
                      {
                        key: "activator",
                        fn: function (ref) {
                          ...
                          return [
                            _c(
                              "v-list-item-avatar",
                              _vm._g(
                                _vm._b({}, "v-list-item-avatar", attrs, false),
                                on
                              ),
                              [
                                _c("v-img", {
                ...
                [_vm._v(" "), _c("span", [_vm._v(_vm._s(item.desc))])]
              ),
            ],
            1
          )
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", { staticClass: "column" }, [
      _c("div", { staticClass: "item" }, [_vm._v("Row 1, Col 1")]),
      _vm._v(" "),
      _c("div", { staticClass: "item" }, [_vm._v("Row 2, Col 1")]),
      _vm._v(" "),
      _c("div", { staticClass: "item" }, [_vm._v("Row 3, Col 1")]),
    ])
  },
  function () {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "column" }, [
      _c("div", { staticClass: "item" }, [_vm._v("Row 1, Col 2")]),
      _vm._v(" "),
      _c("div", { staticClass: "item" }, [_vm._v("Row 2, Col 2")]),
      _vm._v(" "),
      _c("div", { staticClass: "item" }, [_vm._v("Row 3, Col 2")]),
    ])
  },
]
